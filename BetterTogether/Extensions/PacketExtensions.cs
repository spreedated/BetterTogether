...
namespace BetterTogether.Extensions
{
    public static class PacketExtensions
    {
        ...
        public static T? GetData<T>(this BetterTogetherCore.Models.Packet packet)
        {
        ...
        public static void SetData<T>(this BetterTogetherCore.Models.Packet packet, T data)
        {
        ...
        public static byte[] Pack(this BetterTogetherCore.Models.Packet packet)
        {
